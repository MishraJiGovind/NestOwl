...
public class ProposalStringModal {
    String user_id,requirement_id,inventories, stage,propertyimage1,propertyimage2,providelater,verified_document_property,transaction_type,ownership,property_status,price,price_negotiable,booking_amount,
