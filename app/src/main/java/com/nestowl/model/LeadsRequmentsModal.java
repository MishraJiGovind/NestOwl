...
public class LeadsRequmentsModal {
    String id,user_id,requirement_id,name,mobile,email,property_type,property,project_name,city,locality,sublocality,address,want_to,status,created_at,updated_at,bhk_type,area_min,area_min_mezor,
            area_max,area_max_mezor,budget_min,budget_max,adjest_for_builder_property,floor_prefference,number_of_seats,number_meeting_rooms,open_hours,lock_in_period,area_type,
            captur_area_min,captur_area_min_mezor,captur_area_max,captur_area_max_mezor,buildup_area_min,buildup_area_min_mezor,buildup_area_max,buildup_area_max_mezor,super_area_min,
            super_area_min_mezor,super_area_max,super_area_max_mezor,corner_property_prefference,office_min_no_seat,office_max_no_seat,reception_area_prefference,building_class_prefference,
            transaction_type,need_possession,furnisging_prefference,furnishings,direction_prefference,age_of_construction,nature_of_employment,reason_for_buying,additional_requirement_details,
            boundary_wall_made,main_road_property_prefference,want_to_buy,properypost;

    public LeadsRequmentsModal() {
    }

    public LeadsRequmentsModal(String id, String user_id, String requirement_id, String name, String mobile, String email, String property_type, String property, String project_name, String city, String locality, String sublocality, String address, String want_to, String status, String created_at, String updated_at, String bhk_type, String area_min, String area_min_mezor, String area_max, String area_max_mezor, String budget_min, String budget_max, String adjest_for_builder_property, String floor_prefference, String number_of_seats, String number_meeting_rooms, String open_hours, String lock_in_period, String area_type, String captur_area_min, String captur_area_min_mezor, String captur_area_max, String captur_area_max_mezor, String buildup_area_min, String buildup_area_min_mezor, String buildup_area_max, String buildup_area_max_mezor, String super_area_min, String super_area_min_mezor, String super_area_max, String super_area_max_mezor, String corner_property_prefference, String office_min_no_seat, String office_max_no_seat, String reception_area_prefference, String building_class_prefference, String transaction_type, String need_possession, String furnisging_prefference, String furnishings, String direction_prefference, String age_of_construction, String nature_of_employment, String reason_for_buying, String additional_requirement_details, String boundary_wall_made, String main_road_property_prefference, String want_to_buy, String properypost) {
        this.id = id;
