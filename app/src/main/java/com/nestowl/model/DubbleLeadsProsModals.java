...
public class DubbleLeadsProsModals {
    String id,user_id,property_id,site_view,common_area,washroom_view,exterior_view,living_room,p_bedrooms,p_bathrooms,kitchen,floor_plan,master_plan,location_map,others,post_property,
            hide_contact_details,schedule_details_type,prefference_day,prefference_time,whats_app,jio_meet,skype,zoom,google_duo,facetime,brochure,bank,properypost,approval_date,status,
            created_at,updated_at;

    public DubbleLeadsProsModals() {
    }

    public DubbleLeadsProsModals(String id, String user_id, String property_id, String site_view, String common_area, String washroom_view, String exterior_view, String living_room, String p_bedrooms, String p_bathrooms, String kitchen, String floor_plan, String master_plan, String location_map, String others, String post_property, String hide_contact_details, String schedule_details_type, String prefference_day, String prefference_time, String whats_app, String jio_meet, String skype, String zoom, String google_duo, String facetime, String brochure, String bank, String properypost, String approval_date, String status, String created_at, String updated_at) {
        this.id = id;
