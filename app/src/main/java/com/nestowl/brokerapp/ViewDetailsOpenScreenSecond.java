...
public class ViewDetailsOpenScreenSecond extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_details_open_screen_second);
        frame_deal=findViewById(R.id.frame_deal_closed);
        fm_review=findViewById(R.id.review_first);
        ask_for=findViewById(R.id.ALERT_STATUS_TRACKER_ASK_FOR_REVIEW_BTN);
        ...
        fm_review.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent= new Intent(ViewDetailsOpenScreenSecond.this,ReviewBuyerActivity.class);
        ...
        frame_deal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(ViewDetailsOpenScreenSecond.this);
                ...
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(ViewDetailsOpenScreenSecond.this, android.R.color.transparent)));
    ...
    private void yesDialog() {
        Dialog dialog = new Dialog(ViewDetailsOpenScreenSecond.this);
