...
public class RecentSearch extends AppCompatActivity {
    CardView card_two,card_three,card_sec;
    ImageView back_img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card_sec=findViewById(R.id.card_thirdss);
        ...
        card_two.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RecentSearch.this, ScreenSixteenDetailsPage.class);
                startActivity(intent);
            }
        });


        card_sec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(RecentSearch.this, ScreenSixteenDetailsPage.class);
                startActivity(intent);
