...
public class A2SecondQuery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a2_second_query);
        ...
        face_day.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(A2SecondQuery.this);
                ...
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(A2SecondQuery.this, android.R.color.transparent)));
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A2SecondQuery.this,A2FourScreen.class);
