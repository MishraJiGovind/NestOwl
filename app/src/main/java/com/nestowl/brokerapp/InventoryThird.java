...
public class InventoryThird extends AppCompatActivity {
    ImageView back_img;
    FrameLayout f1,f2;
...
ScrollView scrollView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inventory_third);
        ...
        face_day.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(InventoryThird.this);
                ...
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(InventoryThird.this, android.R.color.transparent)));
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(InventoryThird.this,InvetoryThirdFirst.class);
