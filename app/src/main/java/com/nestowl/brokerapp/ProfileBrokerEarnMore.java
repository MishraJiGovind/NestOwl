...
public class ProfileBrokerEarnMore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profile_broker_earn_more);
        ...
        card_earn_more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProfileBrokerEarnMore.this,ProfileBrokerCongratulationScreen.class);
        ...
        card_know_more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProfileBrokerEarnMore.this,SignUpKnowMore.class);
                startActivity(intent);
            }
        });
        ...
        double_leads.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProfileBrokerEarnMore.this,SignUpKnowMoreDoubleLeads.class);
                startActivity(intent);
            }
        });
