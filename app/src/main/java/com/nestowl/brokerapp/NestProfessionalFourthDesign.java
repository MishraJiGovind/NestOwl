...
public class NestProfessionalFourthDesign extends AppCompatActivity {
...
TextView tv_other,tv_first,tv_second,tv_explore,read_disclaimer,tv_profile,tv_read_more,firsts,second,
    ...
    NestProfessionalFourthDesign homeScreen;
    ImageView back_img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nest_professional_fourth_designg);
...
/*
        ...
        tv_read_more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NestProfessionalThirdDesign.this,ReadMoreScreen.class);
        ...
        tv_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(NestProfessionalThirdDesign.this,SahilDahiyaReviews.class);
                startActivity(intent);
            }
        });
...
read_disclaimer.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View v) {
        Intent intent =new Intent(NestProfessionalThirdDesign.this,ReadDisclaimer.class);
        startActivity(intent);
    }
});
*/
...
/*
        ...
        tv_explore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(NestProfessionalThirdDesign.this);
                ...
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(NestProfessionalThirdDesign.this, android.R.color.transparent)));
...
*//*
        property_third.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(NestProfessionalThirdDesign.this, NestProfessionalThirdDesign.class);
                startActivity(intent);
            }
        });*/
/*
        ...
        tv_first.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NestProfessionalThirdDesign.this,SalePropertiesSecondForNestOwners.class);
                startActivity(intent);
            }
        });
        ...
        tv_other.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                lp.height = WindowManager.LayoutParams.WRAP_CONTENT;
                lp.gravity = Gravity.BOTTOM;
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(NestProfessionalThirdDesign.this,
                        android.R.color.transparent)));


                dialog.getWindow().setAttributes(lp);
                dialog.show();
                ImageView im4=dialog.findViewById(R.id.iv4);
        ...
        */
        ...
        /*frm_rer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(NestProfessionalThirdDesign.this,PropertiesBhkActivity.class);
                startActivity(intent);
            }
        });
        ...
        frame_last.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NestProfessionalThirdDesign.this,QueryMakeOfferFirstPages.class);
                startActivity(intent);
            }
        });
        ...
        frame_start_offers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NestProfessionalThirdDesign.this,StartOfferQueryIntro.class);
                startActivity(intent);
            }
        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        maps.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                Intent intent=new Intent(NestProfessionalFourthDesign.this,MapsActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    public  void secondSystem(){
        ...
        Intent intent=new Intent(NestProfessionalFourthDesign.this, NestProfessionalFourthDesign.class);
        startActivity(intent);
    }
