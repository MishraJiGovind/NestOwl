...
public class SignUpKnowMore extends AppCompatActivity {
    ImageView back_img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_up_know_more);
        card_submit=findViewById(R.id.PROFILE_CONTACT_US_SUMBIT);
        card_submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SignUpKnowMore.this,SignUpEarnMoney.class);
