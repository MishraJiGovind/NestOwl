...
public class InventorySecond extends AppCompatActivity {
    ImageView back_img;
    FrameLayout f1,f2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inventory_second);
        ...
        face_day.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(InventorySecond.this);
                ...
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(InventorySecond.this, android.R.color.transparent)));
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(InventorySecond.this,InventorySecondSecond.class);
