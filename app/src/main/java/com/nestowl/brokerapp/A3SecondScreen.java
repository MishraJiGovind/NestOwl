...
public class A3SecondScreen extends AppCompatActivity {
    ImageView back_img;
    FrameLayout f1,f2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a3_second_screen);
        ...
        face_day.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(A3SecondScreen.this);
                ...
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(A3SecondScreen.this, android.R.color.transparent)));
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(A3SecondScreen.this,A3FourScreen.class);
