...
public class GreenTickFiveCardBroker extends AppCompatActivity {
    RadioButton tv_yes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_green_tick_five_card_broker);
        ask_for=findViewById(R.id.ask_for_review_five);
        ...
        fm_review.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent= new Intent(GreenTickFiveCardBroker.this,ReviewActivity.class);
        ...
        tv_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(GreenTickFiveCardBroker.this);
                ...
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(GreenTickFiveCardBroker.this, android.R.color.transparent)));
    ...
    private void yesDialog() {
        Dialog dialog = new Dialog(GreenTickFiveCardBroker.this);
