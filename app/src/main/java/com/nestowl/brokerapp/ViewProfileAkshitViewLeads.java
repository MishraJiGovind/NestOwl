...
public class ViewProfileAkshitViewLeads extends AppCompatActivity {

    TextView tv_make_offer,tv_view_all,tv_view_all_office,tv_view_all_deal_closed,tv_read_more_abt_sahil,tv_review_me;
    FrameLayout f1,f2,f3,f4,back_img;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_profile_akshit_view_leads);
        ...
        tv_review_me.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ViewProfileAkshitViewLeads.this,ReviewMainActivity.class);
        ...
        f4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ViewProfileAkshitViewLeads.this,QueryMakeOfferFirstPages.class);
                startActivity(intent);
        ...
        tv_read_more_abt_sahil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ViewProfileAkshitViewLeads.this,ReadDisclaimer.class);
                startActivity(intent);
    ...
    public void firtsSysteme(){
        ...
        Intent intent=new Intent( ViewProfileAkshitViewLeads.this,PropertiesBhkActivity.class);
        startActivity(intent);
