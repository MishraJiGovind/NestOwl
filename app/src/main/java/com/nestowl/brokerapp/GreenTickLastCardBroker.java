...
public class GreenTickLastCardBroker extends AppCompatActivity {
    RadioButton rad_yes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_green_tick_last_card_broker);
        rad_yes=findViewById(R.id.frame_deal_closed);
        fm_review=findViewById(R.id.review_first);
        lnr_ask=findViewById(R.id.ask_for_review_third);
        ...
        fm_review.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent= new Intent(GreenTickLastCardBroker.this,ReviewBuyerActivity.class);
        ...
        rad_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(GreenTickLastCardBroker.this);
                ...
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(GreenTickLastCardBroker.this, android.R.color.transparent)));
        ...
        lnr_ask.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Dialog dialog = new Dialog(GreenTickLastCardBroker.this);
    ...
    private void yesDialog() {
        Dialog dialog = new Dialog(GreenTickLastCardBroker.this);
