...
public class InventoryThirdLast extends AppCompatActivity {
    ImageView back_img;
    CardView submit;
    TextView tv_near;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inventory_third_last);

        submit=findViewById(R.id.card_submit);
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(InventoryThirdLast.this,MakeOfferCongratulationScreen.class);
