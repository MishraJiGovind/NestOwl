...
public class LeadBoastPlan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lead_boast_plan);
        ...
        if (PrefMananger.getString(this,"subscription")!=null){
            try {
                ...
                for (int i=0;i<jsonArray.length();i++){
                    ...
                    if (modal.getPlan_type().equals("LeadBoost")){
                        ...
                        months.setExtraLine(null);
                        months.setLine("Validity "+modal.getValidity());
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (st.equals("1")){
                        ...
                        PrefMananger.saveString(LeadBoastPlan.this,"subscription",save);
                    }
                }catch (Exception e){
