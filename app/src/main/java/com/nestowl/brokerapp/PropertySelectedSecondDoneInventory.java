...
public class PropertySelectedSecondDoneInventory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_property_selected_second_done_inventory);
        ...
        three.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(PropertySelectedSecondDoneInventory.this,InventoryThird.class);
