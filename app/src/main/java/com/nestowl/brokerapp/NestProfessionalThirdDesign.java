...
public class NestProfessionalThirdDesign extends AppCompatActivity {
...
TextView tv_other,tv_first,tv_second,tv_explore,read_disclaimer,tv_profile,tv_read_more,firsts,second,
    ...
    NestProfessionalThirdDesign homeScreen;
    ImageView back_img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nest_professional_third_designg);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        maps.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                Intent intent=new Intent(NestProfessionalThirdDesign.this,MapsActivity.class);
                startActivity(intent);
            }
        });
    }
