...
NestOwnersSixteen extends AppCompatActivity {
...
*/
        ...
        tv_read_more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NestOwnersSixteen.this,ReadMoreScreen.class);
...
read_disclaimer.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View v) {
        Intent intent =new Intent(NestOwnersSixteen.this,ReadDisclaimer.class);
        startActivity(intent);
    }
});
        tv_explore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final Dialog dialog = new Dialog(NestOwnersSixteen.this);
                ...
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(NestOwnersSixteen.this, android.R.color.transparent)));
...
/*
        ...
        tv_first.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NestOwnersSixteen.this,SalePropertiesSecondForNestOwners.class);
                startActivity(intent);
            }
        });
        ...
        tv_other.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                lp.height = WindowManager.LayoutParams.WRAP_CONTENT;
                lp.gravity = Gravity.BOTTOM;
                dialog.getWindow().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(NestOwnersSixteen.this,
        ...
        frm_rer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(NestOwnersSixteen.this,PropertiesBhkActivity.class);
                startActivity(intent);
            }
        });
        ...
        frame_last.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NestOwnersSixteen.this,QueryMakeOfferFirstPages.class);
                startActivity(intent);
            }
        });
        ...
        frame_start_offers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NestOwnersSixteen.this,StartOfferQueryIntro.class);
                startActivity(intent);
            }
        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        maps.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                Intent intent=new Intent(NestOwnersSixteen.this,MapsActivity.class);
                startActivity(intent);
            }
        });
    }
