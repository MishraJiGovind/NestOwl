...
public class ChangeListenerSecond extends RecyclerView.Adapter<ChangeListenerSecond.Holder>{



    Integer selectedposition = null;

    public ChangeListenerSecond(Context context, ArrayList<BudgetPOJO> firstlist, ChangedListener.OnItemSeleted onItemSeleted) {
    ...
    ChangedListener.OnItemSeleted itemSeleted;

    @NonNull
    @Override
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(context).inflate(R.layout.layout_second_color_change, parent, false);
