 ...
 */
public class PropertiesOfferedSecondd extends Fragment {
    RadioButton rad_owner,rad_agent;
    LinearLayout lnd_owner,lnd_agent;
    Boolean is_Residential_click = false;
    FrameLayout deal_one,deal_two,deal_three,listine_one,listing_two,listing_three;
    FrameLayout deal_four,deal_five,deal_six,deal_saven;
    FrameLayout card_one,card_two,card_three,card_four;
    CardView card_third,card_last;


    public PropertiesOfferedSecondd() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_properties_offered_secondd, container, false);
        ...
        card_third=view.findViewById(R.id.card_third_list);
        card_last=view.findViewById(R.id.card_four_list);
